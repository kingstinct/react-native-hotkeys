...
import { ReactNativeKeysKeyCode } from '../types'

export const keyMap: Record<ReactNativeKeysKeyCode, Key | string | readonly Key[]> = {
  ...
  [ReactNativeKeysKeyCode.Key0]: '0',
  [ReactNativeKeysKeyCode.Key1]: '1',
  [ReactNativeKeysKeyCode.Key2]: '2',
  [ReactNativeKeysKeyCode.Key3]: '3',
  [ReactNativeKeysKeyCode.Key4]: '4',
  [ReactNativeKeysKeyCode.Key5]: '5',
  [ReactNativeKeysKeyCode.Key6]: '6',
  [ReactNativeKeysKeyCode.Key7]: '7',
  [ReactNativeKeysKeyCode.Key8]: '8',
  [ReactNativeKeysKeyCode.Key9]: '9',
  [ReactNativeKeysKeyCode.KeyA]: 'a',
  [ReactNativeKeysKeyCode.KeyB]: 'b',
  [ReactNativeKeysKeyCode.KeyC]: 'c',
  [ReactNativeKeysKeyCode.KeyD]: 'd',
  [ReactNativeKeysKeyCode.KeyE]: 'e',
  [ReactNativeKeysKeyCode.KeyF]: 'f',
  [ReactNativeKeysKeyCode.KeyG]: 'g',
  [ReactNativeKeysKeyCode.KeyH]: 'h',
  [ReactNativeKeysKeyCode.KeyI]: 'i',
  [ReactNativeKeysKeyCode.KeyJ]: 'j',
  [ReactNativeKeysKeyCode.KeyK]: 'k',
  [ReactNativeKeysKeyCode.KeyL]: 'l',
  [ReactNativeKeysKeyCode.KeyM]: 'm',
  [ReactNativeKeysKeyCode.KeyN]: 'n',
  [ReactNativeKeysKeyCode.KeyO]: 'o',
  [ReactNativeKeysKeyCode.KeyP]: 'p',
  [ReactNativeKeysKeyCode.KeyQ]: 'q',
  [ReactNativeKeysKeyCode.KeyR]: 'r',
  [ReactNativeKeysKeyCode.KeyS]: 's',
  [ReactNativeKeysKeyCode.KeyT]: 't',
  [ReactNativeKeysKeyCode.KeyU]: 'u',
  [ReactNativeKeysKeyCode.KeyV]: 'v',
  [ReactNativeKeysKeyCode.KeyW]: 'w',
  [ReactNativeKeysKeyCode.KeyX]: 'x',
  [ReactNativeKeysKeyCode.KeyY]: 'y',
  [ReactNativeKeysKeyCode.KeyZ]: 'z',
}

const mapWebKeyCode = (key: Key): ReactNativeKeysKeyCode | null => (
  (Object.keys(keyMap).find((k) => {
    const val = keyMap[k as unknown as ReactNativeKeysKeyCode] as Key | readonly Key[]
